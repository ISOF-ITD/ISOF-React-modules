...
export default {
	...
	tileLayers: [
		...
		// Lantmäteriet topografisk karta SWEREF99
		{
			...
			url: 'https://ull.isof.se/folkeservice/api/lm_proxy/{z}/{y}/{x}.png',
			options: {
		...
		*/
		...
		},
		{
			...
			url: 'https://ull.isof.se/folkeservice/api/lm_nedtonad_epsg3857_proxy/{z}/{y}/{x}.png',
			options: {
				attribution: '&copy; <a href="https://www.lantmateriet.se/en/">Lantmäteriet</a> Topografisk Webbkarta Visning',
				crossOrigin: true,
			}
...
*/
	...
	overlayTileLayers: [
		// Historiska Ortofoto LM
		{
			...
			url: 'https://ull.isof.se/folkeservice/api/lm_historto_proxy',
		...
		// Ortofoto LM
		{
			...
			url: 'https://ull.isof.se/folkeservice/api/lm_orto_proxy',
